          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <div className="glass-effect rounded-xl p-8 mb-8">
                ...
                <p className="text-lightGray mb-4">We collect the following types of information:</p>
              ...
              <div className="glass-effect rounded-xl p-8 mb-8">
                ...
                <p className="text-lightGray mb-4">Your information is used to:</p>
                <ul className="list-disc pl-6 text-lightGray space-y-2">
              ...
              <div className="glass-effect rounded-xl p-8 mb-8">
                ...
                <p className="text-lightGray mb-4">We may share your information with:</p>
                <ul className="list-disc pl-6 text-lightGray space-y-2">
              ...
              <div className="glass-effect rounded-xl p-8 mb-8">
                ...
                <p className="text-lightGray mb-4">You have the right to:</p>
                <ul className="list-disc pl-6 text-lightGray space-y-2">
              ...
              <div className="glass-effect rounded-xl p-8">
                <h2 className="text-2xl font-bold text-white mb-6">7. Updates to Privacy Policy</h2>
                <p className="text-lightGray mb-4">
                  We may update this privacy policy periodically. Users will be notified of significant
                  changes, and continued use of our services constitutes acceptance of the updated policy.
                </p>
              </div>
            </motion.div>
          </div>
