        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-lg text-lightGray">
              Revolutionizing urban transportation with premium service and cutting-edge technology
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-lightGray">
                <p>
                  Founded in 2020, TaxiGo emerged from a vision to transform urban transportation.
                  We saw an opportunity to combine premium service with cutting-edge technology,
                  creating a taxi service that truly puts customers first.
                </p>
                <p>
                  Today, we're proud to serve thousands of customers daily, providing safe,
                  reliable, and comfortable rides across major cities. Our commitment to excellence
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-dark/50 to-transparent rounded-xl" />
            </motion.div>
          </div>
        </div>
      </section>
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-lightGray">{member.bio}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-lightGray">
                To provide safe, reliable, and comfortable transportation services that exceed
                customer expectations while contributing to sustainable urban mobility.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
